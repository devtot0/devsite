...
$popup_background = ( isset($popup_background) ) ? haru_get_option('haru_popup_background')['url'] : '';
$popup_content    = haru_get_option('haru_popup_content');

?>
<!-- Display newsletter popup -->
<?php if ( haru_get_option('haru_show_popup') != false ) : ?>
    <div class="haru_popup_link hide"><a class="haru-popup open-click" href="#haru-popup" data-effect="<?php echo esc_attr( $popup_effect ); ?>" data-delay="<?php echo esc_attr( $popup_delay ); ?>"><?php echo esc_html__( 'Newsletter', 'pangja' ); ?></a></div>
        ...
        <div class="popup-right">
            <div class="popup-right-content">
                ...
                <p class="checkbox-label">
                    ...
                    <label for="showagain"><?php echo esc_html__( "Don't show this popup again", 'pangja' ); ?></label>
                </p>
            </div>
        </div>
    </div>

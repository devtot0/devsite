            ...
            <div class="post-detail">
                ...
                <div class="post-detail-content">
                    ...
                    <div class="post-read-more">
                        <a href="<?php the_permalink(); ?>" class="read-more" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php echo esc_html__( 'Read more', 'pangja' ); ?><i class="ion ion-md-arrow-forward"></i></a>
                    </div>

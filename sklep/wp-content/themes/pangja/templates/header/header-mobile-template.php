...
$mobile_header_wishlist = haru_get_option('haru_mobile_header_wishlist');
// Set default
if ( !isset($mobile_header_wishlist) ) {
    $mobile_header_wishlist = '1';
}
    ...
    <div class="<?php echo esc_attr( join(' ', $header_container_wrapper_class) ); ?>">
        <div class="container haru-mobile-header-container">
            ...
            <div id="haru-nav-mobile-menu" class="<?php echo esc_attr( join(' ', $header_mobile_nav) ); ?>">
                <div class="mobile-menu-header"><?php echo esc_html__( 'Menu', 'pangja' ); ?><span class="mobile-menu-close"></span></div>

                <div class="mobile-header-elements">
                    <?php if ( class_exists( 'WooCommerce' ) && $mobile_header_wishlist == '1' ) : ?>
                        <?php get_template_part( 'templates/header/header-elements/wishlist' ); ?>
                    <?php endif; ?>

                    <?php if ( $mobile_header_account == '1' ) : ?>
                        <?php get_template_part('templates/header/header-elements/user-account'); ?>
                    <?php endif; ?>

...
if ($enable_header_elements == '1') {
    $header_social_network = get_post_meta( get_the_ID(), 'haru_header_elements_nav_social_network', false );
} else {
    if ( haru_get_option('haru-option-header-elements-nav') == '1' ) {
        $header_social_network = haru_get_option('haru_header_elements_nav_social_network');
    } else {
        return;
    }
}

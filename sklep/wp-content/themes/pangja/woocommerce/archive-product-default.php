...
<div class="haru-archive-product">
    ...
    <?php endif; ?>
        ...
        <?php endif; ?>
            ...
            <div class="col-md-<?php echo esc_attr($archive_product_content_col); ?> <?php if( is_active_sidebar( $archive_product_left_sidebar ) && ($archive_product_sidebar == 'left') ) echo esc_attr('has-left-sidebar'); ?> <?php if( is_active_sidebar( $archive_product_right_sidebar ) && ($archive_product_sidebar == 'right') ) echo esc_attr('has-right-sidebar'); ?> col-sm-12 col-xs-12">

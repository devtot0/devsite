...
class WPD_Clipart {
    ...
    public function get_cliparts_page() {
        ...
        <br><br><strong><?php _e('Note: ', 'wpd'); ?></strong><?php _e('Please hold Ctrl or Cmd to select multiple cliparts at once from the medias popup.', 'wpd'); ?> 
        <script>

...
class WPD_Skin_Porto_Novo {
    ...
    public function display() {
        ...
        ?>
        <div class="wpc-container wpc-porto-skin ">      
            <div class="wpc-editor-wrap ">
                <div class="wpc-editor-col wpc-editor-col-tools is-open">
                    <div class="wpc-tools-container" >
                        ...
                        <div class="wpc-tools-wrap">
                            <div class="wpc-tools-head" id="text-panel">
                                <div id="text" class="icon-261"></div>
                            </div>
                        ...
                        <div class="wpc-tools-wrap">
                            <div class="wpc-tools-head" id="cliparts-panel">
                                <div id="cliparts" class="icon-1143"></div>
                            </div>
                            <div id="cliparts-panel-content" class="wpc-tools-content">
                                ...
                                <div class="wpc-tools-wrap">
                                    <div class="wpc-tools-head" id="uploads-panel">
                                        <div id="uploads" class="icon-1197"></div>
                                    </div>
                                ...
                                <div class="wpc-tools-wrap">
                                    <div class="wpc-tools-head" id="shapes-panel">
                                        <div id="shapes" class="icon-951"></div>
                                    </div>
                                    <div id="shapes-panel-content" class="wpc-tools-content">
                                        ...
                                        <div  class="wpc-panel-head">
                                            ...
                                            <ul id="wpc-shapes-tabs" class="wpc-tabs">
                                                <li class="wpc-tab-link current" data-tab="tab-add-shapes"><?php _e('Add shape', 'wpd'); ?></li>
                                                <li class="wpc-tab-link" data-tab="tab-shape-edit"><?php _e('Edit shape', 'wpd'); ?></li>
                                            </ul>
                                        </div>
                                        <div id="tab-add-shapes" class="wpc-tab-content current">
                                            <?php $this->get_shapes_tools($shapes_options, $colors_options); ?>
                                        </div>
                                        <div id="tab-shape-edit" class="wpc-tab-content">
                                ...
                                <div class="wpc-tools-wrap">
                                    <div class="wpc-tools-head" id="add-cart-panel">
                                        <div id="add-cart-content" class="icon-1325"></div>
                                    </div>
                            ...
                            </div><!--wpc-tools-container-->
                        </div><!--wpc-editor-col-tools-->
                            ...
                            <div class="container">
                                <div id="tab-customize" class="wpd-tab-content current">
                                    ...
                                    <div id="wpc-editor-container">
                                        <span class="wpd-editor-side">
                                            <div class="wpc-button-bar-wrap">
                                                <div class="wpc-button-bar">
                                                    <span id="grid-btn" class="icon-1216" data-placement="right" data-tooltip-title="grid"></span>
                                                    <span id="copy_paste_btn" class="icon-443 wpd_btn_hidden" data-placement="right" data-tooltip-title="Duplicate"></span>
                                                    <span id="align_btn" class="icon-683 wpd_btn_hidden" data-placement="right" data-tooltip-title="Alignments"></span>
                                                    <div class="align_btn_wrap">
                                                        <div>
                                                            <span id="send_to_back_btn" class="icon-677" data-placement="bottom" data-tooltip-title="Send to back"></span>
                                                            <span id="bring_to_front_btn" class="icon-676" data-placement="bottom" data-tooltip-title="Bring to front"></span>
                                                            <span id="flip_h_btn" class="icon-687" data-placement="bottom" data-tooltip-title="Flip horizontally"></span>
                                                            <span id="flip_v_btn" class="icon-691" data-placement="top" data-tooltip-title="Flip vertically"></span>
                                                            <span id="align_h_btn" class="icon-680" data-placement="top" data-tooltip-title="Center horizontally"></span>
                                                            <span id="align_v_btn" class="icon-682" data-placement="top" data-tooltip-title="Center vertically"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php $this->get_parts(); ?>
                                        ...
                                        <span class="wpd-editor-center-wrap">
                                            
                                            <canvas id="wpc-editor"></canvas>
                                            <?php echo wpd_built_with(); ?>
                                        </span>
                                        <span class="wpd-editor-side wpd-editor-right-tools-wrap">
                                            <div class="wpc-button-bar-wrap">
                                                <div class="wpc-button-bar">
                                                    <span id="undo-btn" class="icon-wpd_icons-09 disabled" data-placement="left" data-tooltip-title="Undo"></span>
                                                    <span id="redo-btn" class="icon-wpd_icons-08 disabled" data-placement="left" data-tooltip-title="Redo"></span>
                                                </div>
                                                <div class="wpc-button-bar">
                                                    <span id="clear_all_btn" class="icon-1407 wpd_btn_hidden" data-placement="left" data-tooltip-title="Clear all"></span>
                                                    <span id="delete_btn" class="icon-014 wpd_btn_hidden" data-placement="left" data-tooltip-title="Delete"></span>
                                                </div>
                                                <?php
                                ...
                                ?>
                                <div id="debug-wrap"><div id="debug"></div><div class="debug-icon ti-close"></div></div> 
                            </div><!--container-->
                        </div><!--wpc-editor-col-2-->
                    </div><!--wpc-editor-wrap-->
                </div><!--end wpc-container-->
                <!--end old editor-->
                <?php
                $output = ob_get_clean();
                return $output;
            ...
            private function get_text_tools($text_options) {
                ...
                <div class="wpc-panel-head">
                    ...
                    <ul id="wpc-text-tabs" class="wpc-tabs">
                ...
                <div class="text-tool-container dspl-table wpd-tools-content-scroll-wrap">
            ...
            private function get_uploads_tools($options) {
                ...
                <?php do_action('wpd_uploads_section_end', $this->editor->wpd_product); ?>
                <?php
            }
            ...
            function get_images_tools($options) {
                ...
                $output .= '<span class="wpc-panel-title" id="wpd-clipart-group-selected"></span>';
            ...
            private function get_design_actions_box() {
                ...
                if (isset($preview_btn) && $preview_btn !== '0') {
                    ?>
                    <span id="preview-btn" class="icon-491" data-placement="left" data-tooltip-title="<?php _e('PREVIEW', 'wpd'); ?>"></span>                         
                    <?php
                }
                if (!is_admin()) {
                    if (isset($download_btn) && $download_btn !== '0') {
                        ?>
                        <span id="download-btn" class="icon-1166" data-placement="left" data-tooltip-title="<?php _e('DOWNLOAD', 'wpd'); ?>"></span>
                        <?php
                    }
                }
            ...
            private function register_scripts() {
                ...
                wp_enqueue_script('wpd-porto-skin-js', WPD_URL . 'includes/skins/porto-novo/assets/js/porto.js', array('jquery'), WPD_VERSION, false);
            ...
            private function register_styles() {
                wp_enqueue_style('wpd-porto-skin-css', WPD_URL . 'includes/skins/porto-novo/assets/css/porto.css', array(), WPD_VERSION, 'all');
                wp_enqueue_style('wpd-line-icons-css', WPD_URL . 'includes/skins/porto-novo/assets/css/line-icons.css', array(), WPD_VERSION, 'all');
                wp_enqueue_style('wpd-icons-css', WPD_URL . 'includes/skins/porto-novo/assets/css/wpd_icons.css', array(), WPD_VERSION, 'all');
                wp_enqueue_style('wpd-font-awesome-css', WPD_URL . 'includes/skins/porto-novo/assets/css/font-awesome.min.css', array(), WPD_VERSION, 'all');
                wp_enqueue_style('wpd-mCustomScrollbar-css', WPD_URL . 'includes/skins/porto-novo/assets/css/jquery.mCustomScrollbar.min.css', array(), WPD_VERSION, 'all');

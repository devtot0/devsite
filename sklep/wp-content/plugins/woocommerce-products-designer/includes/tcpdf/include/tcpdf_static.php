...
//		}
	 ...
	 * <li>RA1 (610x860 mm ; 23.02x33.86 in)</li>
	 * <li>RA2 (430x610 mm ; 16.93x23.02 in)</li>
	 ...
	 * <li>SUPER_A4 (227x356 mm ; 8.94x13.02 in)</li>
	 ...
	 * <li>ANSI_E (864x1118 mm ; 33.00x43.00 in)</li>
	 * <li>ANSI_D (559x864 mm ; 22.00x33.00 in)</li>
	 ...
	 * <li>LEGAL, USLEGAL (216x356 mm ; 8.50x13.00 in)</li>
	 ...
	 * <li>ARCH_D (610x914 mm ; 23.00x36.00 in)</li>
	 * <li>ARCH_C, BROADSHEET (457x610 mm ; 18.00x23.00 in)</li>
	 ...
	 * <li><b>PA Series</b></li>
	 * <li>PA0 (840x1120 mm ; 33.07x43.09 in)</li>
	 ...
	 * <li>4R, KG (102x152 mm ; 3.02x5.98 in)</li>
	 ...
	 * <li>11R (279x356 mm ; 10.98x13.02 in)</li>
	 ...
	 * <li>EN_ATLAS (660x864 mm ; 26.00x33.00 in)</li>
	 ...
	 * <li>FR_DOUBLE_JESUS (760x1120 mm ; 29.92x43.09 in)</li>
	...
	public static function getPageSizeFromFormat($format) {
		...
		switch (strtoupper($format)) {
			...
			case 'B1' : {$pf = array( 2003.094, 2834.646); break;}
			case 'B2' : {$pf = array( 1417.323, 2003.094); break;}
			...
			case 'ANSI_D': {$pf = array( 1583.000, 2448.000); break;}
			case 'ANSI_C': {$pf = array( 1223.000, 1583.000); break;}
			case 'ANSI_B': {$pf = array(  792.000, 1223.000); break;}
			case 'ANSI_A': {$pf = array(  612.000,  792.000); break;}
			// Traditional 'Loose' North American Paper Sizes
			case 'USLEDGER':
			case 'LEDGER' : {$pf = array( 1223.000,  792.000); break;}
			case 'ORGANIZERK':
			case 'BIBLE':
			case 'USTABLOID':
			case 'TABLOID': {$pf = array(  792.000, 1223.000); break;}
			case 'ORGANIZERM':
			case 'USLETTER':
			...
			case 'ARCH_E1': {$pf = array( 2160.000, 3023.000); break;}
			case 'ARCH_D' : {$pf = array( 1728.000, 2592.000); break;}
			case 'BROADSHEET':
			case 'ARCH_C' : {$pf = array( 1296.000, 1728.000); break;}
			case 'ARCH_B' : {$pf = array(  863.000, 1296.000); break;}
			case 'ARCH_A' : {$pf = array(  648.000,  863.000); break;}
			// --- North American Envelope Sizes ---
			//   - Announcement Envelopes
			case 'ANNENV_A2'  : {$pf = array(  314.640,  413.000); break;}
			...
			case 'COMMENV_N10'   : {$pf = array(  296.640,  683.000); break;}
			case 'COMMENV_N11'   : {$pf = array(  323.000,  746.640); break;}
			...
			case 'EN_SHEET':
			case 'EN_HALF_POST'        : {$pf = array( 1403.000, 1692.000); break;}
			case 'EN_SUPER_ROYAL'      : {$pf = array( 1368.000, 1943.000); break;}
			...
			case 'EN_FOOLSCAP'         : {$pf = array(  972.000, 1223.000); break;}
			case 'EN_SMALL_FOOLSCAP'   : {$pf = array(  953.000, 1188.000); break;}
			...
			case 'FR_ECU'              : {$pf = array( 1133.858, 1473.016); break;}

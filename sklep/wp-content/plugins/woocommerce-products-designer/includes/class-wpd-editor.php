...
class WPD_Editor {
    ...
    function get_editor() {
        ...
        $skin = apply_filters('wpd_loaded_skin', get_proper_value($ui_options, 'skin', 'WPD_Skin_Porto_Novo'));

        wpd_init_canvas_vars($wpc_metas, $product, $this, $skin);
                
        if($skin == 'WPD_Skin_Porto_Novo'){
            if ( wp_is_mobile() ) {
                $skin = 'WPD_Skin_Porto_Novo_Mobile';

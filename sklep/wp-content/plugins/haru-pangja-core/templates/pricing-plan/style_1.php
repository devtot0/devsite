                    ...
                    <div class="plan-content">
                        <div class="plan-header">
                            ...
                            <div class="plan-price">
                                ...
                                <?php endif; ?>    
                                <div class="plan-unit"><?php if ( $plan['price'] != '0' ) echo esc_html( $time_unit ); ?></div>                 
                            </div>
                        </div>
                        ...
                        <?php if ( $link != '' ) : ?>
                            <a href="<?php echo esc_url($link['url']); ?>" class="plan-link" target="<?php echo esc_attr( ($link['target'] != '') ? $link['target'] : '_self' ); ?>"><?php echo esc_html__( 'Get Started', 'haru-pangja' ); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>

...
<?php if ( $posts->have_posts() ) : ?>
    <div class="post-list-shortcode-wrap <?php echo esc_attr($layout_type . ' ' . $el_class); ?>">
            ...
            <article class="post-list-item">
                ...
                <div class="post-thumbnail">
                    <div class="post-image">
                        <?php echo get_the_post_thumbnail( null, 'thumbnail', array( 'title' => strip_tags( get_the_title() ) ) ); ?>
                    </div>
                </div>
            </article>
            <?php endwhile; ?>

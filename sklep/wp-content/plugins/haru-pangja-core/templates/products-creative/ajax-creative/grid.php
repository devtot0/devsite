...
$classes   = array();
$classes[] = 'haru-woo-shortcodes-products-ajax-creative';
...
$shortcode_id = uniqid();
$rand_id  = 'haru-product-ajax-creative-' . rand();
$selector = '#' . $rand_id;
...
<?php if ( $products->have_posts() ) : ?>
    <div class="<?php echo esc_attr( implode(' ', $classes) ); ?>" id="<?php echo esc_attr($rand_id) ?>" data-atts="<?php echo htmlentities( json_encode($atts) ); ?>">
        ...
        <div id="product-ajax-creative-<?php echo esc_attr($shortcode_id); ?>">
            ...
            <div class="products-content <?php echo esc_attr( $layout_type ); ?>">
            </div>

...
<div class="footer-contact-shortcode-wrap <?php echo esc_attr( $layout_type . ' ' . $el_class); ?>">
    <div class="footer-contact-content">
        <ul class="contact-information">
            ...
            ?>
                    <li><span class="contact-icon <?php echo $iconClass; ?>"></span><span class="contact-label"><?php echo esc_html($contact['title']); ?></span><?php echo wp_kses_post( $contact['description'] ); ?></li>
            <?php endforeach; ?>
        </ul>
    </div>
</div>
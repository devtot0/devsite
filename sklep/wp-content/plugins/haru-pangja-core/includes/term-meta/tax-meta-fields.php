<?php
	...
	if ( ! function_exists( 'haru_variation_styling' ) ):
		...
		function haru_variation_styling() {
			...
			$fields[ 'color' ] = array(
				array(
					'label' => esc_html__( 'Color', 'haru-pangja' ), // <label>
					'desc'  => esc_html__( 'Choose a color', 'haru-pangja' ), // description
			...
			$fields[ 'image' ] = array(
				array(
					'label' => esc_html__( 'Image', 'haru-pangja' ), // <label>
					'desc'  => esc_html__( 'Choose a Image', 'haru-pangja' ), // description
			...
			$fields[ 'label' ] = array(
				array(
					'label' => esc_html__( 'Label', 'haru-pangja' ), // <label>
					'desc'  => esc_html__( 'The text of label (should be same as name)', 'haru-pangja' ), // description

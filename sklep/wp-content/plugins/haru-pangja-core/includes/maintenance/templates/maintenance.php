...
<html <?php language_attributes(); ?>>
    ...
    <head>
        ...
        <?php if ( ! function_exists( 'has_site_icon' ) || ! has_site_icon() ) : ?>
            <?php if ( NULL !== haru_get_option('custom_favicon')['url'] && !empty(haru_get_option('custom_favicon')['url']) ) : ?>
                <link rel="shortcut icon" href="<?php echo esc_url(haru_get_option('custom_favicon')['url']); ?>" />
            <?php else : ?>
        ...
        <link href="<?php echo get_template_directory_uri(). '/assets/libraries/fonts-awesome/css/font-awesome.min.css'; ?>" rel="stylesheet" type="text/css" />
        <script src="<?php echo plugins_url(). '/haru-pangja-core/includes/shortcodes/countdown/assets/js/redcountdown/jquery.knob.min.js'; ?>"></script>
        <script src="<?php echo plugins_url(). '/haru-pangja-core/includes/shortcodes/countdown/assets/js/redcountdown/jquery.ba-throttle-debounce.min.js'; ?>"></script>
        <script src="<?php echo plugins_url(). '/haru-pangja-core/includes/shortcodes/countdown/assets/js/redcountdown/jquery.redcountdown.js'; ?>"></script>
    </head>
            ...
            <div class="maintanence-page">
                <div class="container">
                    ...
                    <div class="countdown-wrapper">
                        <div id="countdown-content-<?php echo $time_id;?>" class="countdown-content" data-date="<?php echo esc_attr( $online_time );?>"></div>
                    </div>

...
if ( ! class_exists('Haru_Products_Ajax_Creative') ) {
    class Haru_Products_Ajax_Creative {
        function __construct() {
            add_shortcode('haru_products_ajax_creative', array($this, 'haru_products_ajax_creative_shortcode' ));
            add_action( 'vc_before_init', array($this, 'haru_products_ajax_creative_vc_map') );
        ...
        function haru_products_ajax_creative_shortcode($atts) {
            $atts  = vc_map_get_attributes( 'haru_products_ajax_creative', $atts );
        ...
        <div class="<?php echo esc_attr( $haru_animation . ' ' . $styles_animation ); ?>">
            <?php echo haru_get_template('products-creative/ajax-creative/' . $layout_type .'.php', array('atts' => $atts), '', '' ); ?>
        </div>
        <?php
            wp_reset_postdata();
        ...
        function haru_products_ajax_creative_vc_map() {
            vc_map( 
                array(
                    'base'        => 'haru_products_ajax_creative',
                    'name'        => esc_html__( 'Haru Products Ajax Creative', 'haru-pangja' ),
                    'class'       => '',
                    'icon'        => 'fa fa-shopping-cart haru-vc-icon',
                    'description' => esc_html__( 'Display products in category via ajax load with creative layout', 'haru-pangja' ),
                    ...
                    'params'      => array(
                        ...
                        array(
                            ...
                            'type'        => 'dropdown',
                            'heading'     => esc_html__( 'Filter Position', 'haru-pangja' ),
                            'description' => esc_html__( 'Select position of filter', 'haru-pangja'),
                            'admin_label' => true,
                            'value'       => array(
    ...
    new Haru_Products_Ajax_Creative();
}
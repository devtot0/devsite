...
add_action( 'wp_ajax_haru_get_product_content_in_category_tab', 'haru_get_product_content_in_category_tab' );
add_action( 'wp_ajax_nopriv_haru_get_product_content_in_category_tab', 'haru_get_product_content_in_category_tab' );

if( !function_exists('haru_get_product_content_in_category_tab') ) {
	function haru_get_product_content_in_category_tab( $atts ) {

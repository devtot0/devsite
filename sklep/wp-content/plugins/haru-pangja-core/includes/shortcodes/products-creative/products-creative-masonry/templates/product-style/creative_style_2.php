    ...
    <div class="product-item-inner">
        <div class="product-thumb">
            <a href="<?php echo esc_url(get_the_permalink()); ?>">
                <img class="attachment-shop_catalog wp-post-image" width="<?php echo esc_attr($ratio_width) ?>px" height="<?php echo esc_attr($ratio_height) ?>px" alt="" src="<?php echo esc_url($haru_img_resize) ?>">
            </a>

    ...
    <div class="product-inner">
        ...
        <div class="product-info">
            ...
            <div class="product-sale-countdown">
                ...
                data-days-text="<?php echo esc_attr__( 'Days', 'haru-pangja' ); ?>" 
                data-hours-text="<?php echo esc_attr__( 'Hours', 'haru-pangja' ); ?>" 
                data-minutes-text="<?php echo esc_attr__( 'Mins', 'haru-pangja' ); ?>" 
                data-seconds-text="<?php echo esc_attr__( 'Secs', 'haru-pangja' ); ?>" 

    ...
    <div class="product-inner">
        ...
        <div class="product-info">
            ...
            <div class="product-sale-countdown">
                ...
                data-days-text="<?php echo esc_html__( 'Days', 'milo-woo-shortcodes' ); ?>" 
                data-hours-text="<?php echo esc_html__( 'Hours', 'milo-woo-shortcodes' ); ?>" 
                data-minutes-text="<?php echo esc_html__( 'Mins', 'milo-woo-shortcodes' ); ?>" 
                data-seconds-text="<?php echo esc_html__( 'Secs', 'milo-woo-shortcodes' ); ?>" 

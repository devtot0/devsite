...
if ( ! class_exists('Haru_Framework_Shortcode_Products_Top_Rated') ) {
    class Haru_Framework_Shortcode_Products_Top_Rated {
        function __construct() {
            add_shortcode( 'haru_products_top_rated', array($this, 'haru_products_top_rated_shortcode' ) );
            add_action( 'vc_before_init', array($this, 'haru_products_top_rated_vc_map') );
        }

        function haru_products_top_rated_shortcode($atts) {
            global $woocommerce;

            $atts  = vc_map_get_attributes( 'haru_products_top_rated', $atts );
            ...
            <div class="<?php echo esc_attr($haru_animation . ' ' . $styles_animation); ?>">
                <?php echo haru_get_template('products/top-rated.php', array('atts' => $atts), '', '' ); ?>
            </div>
        ...
        function haru_products_top_rated_vc_map() {
            vc_map(
                array(
                    'base'        => 'haru_products_top_rated',
                    'name'        => esc_html__( 'Haru Products Top Rated', 'haru-pangja' ),
                    ...
                    'params'      => array(
                        ...
                        array(
                            ...
                            'std'         => 'carousel',
                            'value'       => array(
                                esc_html__( 'Carousel (1 Colum - Multi Rows)', 'haru-pangja' ) => 'carousel_1',
                                esc_html__( 'Grid (Multi Rows)', 'haru-pangja' )     => 'grid',
                            )
                        ),
                        array(
    ...
    new Haru_Framework_Shortcode_Products_Top_Rated();
}
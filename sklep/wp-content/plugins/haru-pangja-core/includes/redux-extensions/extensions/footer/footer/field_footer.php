    ...
    class ReduxFramework_footer extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : esc_html__( 'Select an item', 'haru-pangja' );
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found.', 'haru-pangja' ) . '</strong>';
            }
        } //function
        ...
        public function enqueue() {
            ...
            // $extension = ReduxFramework_extension_footer::getInstance();
        
            wp_enqueue_script(
                'redux-field-footer-js', 
                $this->extension_url . 'field-footer.js', 
                array( 'jquery' ),
                time(),
                true
            );
            ...
            wp_enqueue_style(
                ...
                $this->extension_url . 'field-footer.css',
                time(),
                true
            );

...
if ( !class_exists( 'ReduxFramework_extension_wbc_importer' ) ) {
    ...
    class ReduxFramework_extension_wbc_importer {
            ...
            if ( isset( $_REQUEST['type'] ) && $_REQUEST['type'] == "import-demo-content" && array_key_exists( $_REQUEST['demo_import_id'], $this->wbc_import_files ) ) {
                ...
                if ( file_exists( $demo_data_loc.'/'.$import_parts['content_file'] ) && is_file( $demo_data_loc.'/'.$import_parts['content_file'] ) ) {
                    ...
                    if ( !isset( $import_parts['imported'] ) || true === $reimporting ) {
                        ...
                        echo esc_html__( "Demo Already Imported", 'haru-pangja' );
                    }
                }
        ...
        function add_importer_section() {
            ...
            $wbc_importer_label = trim( esc_html( apply_filters( 'wbc_importer_label', __( 'Demo Importer', 'haru-pangja' ) ) ) );

            $wbc_importer_label = ( !empty( $wbc_importer_label ) ) ? $wbc_importer_label : __( 'Demo Importer', 'haru-pangja' );

            $this->parent->sections[] = array(
                'id'     => 'wbc_importer_section',
                'title'  => $wbc_importer_label,
                'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', esc_html__( 'Works best to import on a new install of WordPress', 'haru-pangja' ) ).'</p>',
            ...
            $this->parent->sections[] = array(
                'title'      => esc_html__( 'Maintenance Mode', 'haru-pangja' ),
                'desc'       => '',
                'subsection' => false,
                ...
                'fields'     => array(
                    array(
                        ...
                        'type'     => 'button_set',
                        'title'    => esc_html__( 'Maintenance Mode', 'haru-pangja' ),
                        'subtitle' => esc_html__( 'Enable/Disable your site maintenance mode.', 'haru-pangja' ),
                        'desc'     => '',
                        'options'  => array(
                            '1' => 'On',
                            '0' => 'Off',
                    ...
                    array(
                        ...
                        'title'       => esc_html__('Maintenance title', 'haru-pangja'),
                        'subtitle'    => esc_html__('Insert coming soon title.', 'haru-pangja'),
                    ...
                    array(
                        ...
                        'url'      => true,
                        'required' => array('enable_maintenance', '=', '1'),
                        'title'    => esc_html__('Maintenance Background', 'haru-pangja'),
                        'subtitle' => esc_html__('Select maintenance background image.', 'haru-pangja'),
                        'desc'     => '',
                        'default'  => '',
                        'args'     => array()
                    ),
                    array(
                        ...
                        'required'    => array('enable_maintenance', '=', '1'),
                        'title'       => esc_html__( 'Online time', 'haru-pangja' ),
                        'subtitle'    => esc_html__( 'Your page will automatic end maintenance mode after this time.', 'haru-pangja' ),
                    ),
                    array(
                        'id'          => 'timezone',
                        'type'        => 'text',
                        ...
                        'required'    => array('enable_maintenance', '=', '1'),
                        'title'       => esc_html__('Timezone', 'haru-pangja'),
                        'subtitle'    => esc_html__('You can change timezone from here. More details: http://php.net/manual/en/timezones.php', 'haru-pangja'),
                    ...
                    array(
                        ...
                        'required' => array('enable_maintenance', '=', '1'),
                        'width'    => '100%',
                        'title'    => esc_html__('Maintenance social profiles', 'haru-pangja'),
                        'subtitle' => esc_html__('Select social profile for maintenance page.', 'haru-pangja'),
                        'options'  => array(
        ...
        *************************************************************************/
        ...
        function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
            ...
            *************************************************************************/
            ...
            if ( class_exists( 'RevSlider' ) ) {
                ...
                $wbc_sliders_array = array(
                    ...
                    'home5' => 'home-5.zip', //Set slider zip name doesn't have slideshow
            ...
            *************************************************************************/
            ...
            // If it's demo1 - demo6
            $wbc_menu_array = array( 'home1', 'home2', 'home3', 'home4', 'home5', 'home6', 'home7' );
            ...
            if ( isset( $demo_active_import[$current_key]['directory'] ) && !empty( $demo_active_import[$current_key]['directory'] ) && in_array( $demo_active_import[$current_key]['directory'], $wbc_menu_array ) ) {
                ...
                $popup_menu = get_term_by( 'name', 'Popup Menu', 'nav_menu' );
                ...
                if ( isset( $top_menu->term_id ) && isset( $mobile_menu->term_id ) ) {
                    set_theme_mod( 'nav_menu_locations', array(
                            ...
                            'right' => $right_menu->term_id,
                            'popup' => $popup_menu->term_id,
                        )
                    );
                }

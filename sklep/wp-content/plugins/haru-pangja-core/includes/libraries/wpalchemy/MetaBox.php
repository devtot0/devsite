...
class WPAlchemy_MetaBox
{
	...
	{
		echo sprintf('%s', $this->get_the_value($n));
	}
	...
	{
		echo sprintf('%s', $this->get_the_name($n));
	}
	...
	function the_index()
	{
		echo esc_html($this->get_the_index());
	}
	...
	{
		echo sprintf('%s', $this->get_the_checkbox_state($n, $v, $is_default));
	}
	...
	{
		echo sprintf('%s', $this->get_the_select_state($n, $v, $is_default));
	}
	...
	{
		echo sprintf('%s', $this->get_the_group_open($t));
	}
	...
	{
		echo sprintf('%s', $this->get_the_group_close());
	}

...
class Haru_WC_Widget_Color_Filter extends Haru_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = esc_html__( 'Shows "color" attributes in a widget which lets you narrow down the list of products when viewing products. ', 'haru-pangja' );
        $this->widget_id          = 'haru_woocommerce_color_filter';
        $this->widget_name        = esc_html__( 'Haru WooCommerce Color Filter', 'haru-pangja' );
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        if ( empty( $new_instance['title'] ) ) {
            $new_instance['title'] = esc_html__( 'Color', 'haru-pangja' );
        }
    ...
    public function form( $instance ) {
        ...
        <p>
            <label>
                <?php echo esc_html__( 'Title', 'haru-pangja' ); ?><br />
                <input class="widefat" type="text" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>" />
            </label>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'columns' ) ); ?>"><?php echo esc_html__( 'Columns', 'haru-pangja' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'query_type' ) ); ?>"><?php echo esc_html__( 'Query type', 'haru-pangja' ); ?></label>
            <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'query_type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'query_type' ) ); ?>">
                <option value="and" <?php selected( $instance['query_type'], 'and' ); ?>><?php echo esc_html__( 'AND', 'haru-pangja' ); ?></option>
                <option value="or" <?php selected( $instance['query_type'], 'or' ); ?>><?php echo esc_html__( 'OR', 'haru-pangja' ); ?></option>
            </select>
        </p>
        <div class="haru-widget-attributes-table">
            <?php
                ...
                if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) {
                    ...
                    $output = sprintf( '<table><tr><th>%s</th><th>%s</th></tr>', esc_html__( 'Term', 'haru-pangja' ), esc_html__( 'Color', 'haru-pangja' ) );

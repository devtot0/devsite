 ...
 * @author      HaruThemes
 * @category    Widgets
 * @package     HaruThemes/Abstracts
 * @version     2.1.0
 * @extends     WP_Widget
 */
abstract class Haru_Widget extends WP_Widget {
				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo esc_html__('Click to browse icon','haru-pangja') ?>" class="browse-icon button-secondary" type="button" value="<?php echo esc_html__('Browse...','haru-pangja') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo esc_html__('Click to browse image','haru-pangja') ?>" class="browse-images button-secondary" type="button"><?php echo esc_html__('Browse...','haru-pangja') ?></button>
						</div>

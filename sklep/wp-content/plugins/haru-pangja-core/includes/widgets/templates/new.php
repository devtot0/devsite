...
<div class="widget_acf_wrap" id="<?php echo esc_attr($data_section_wrap) ?>">
    ...
    if ( isset($fields) && is_array($fields) ) {
            ...
            <div class="widget_acf_accordion" id="<?php echo esc_attr($section_id) ?>">
                ...
                <div class="fieldset" data-collapse="0">
                    <?php foreach ($fields as $field) {
                        ...
                        $placeholder       = (isset ($field['placeholder'])) ? esc_attr($field['placeholder']) : esc_html__('Title', 'redux-framework');
                        ...
                        $multiple              = array_key_exists('multiple', $field) && isset($field['multiple']) && $field['multiple']=='1' ? 'multiple' : '';
                        ...
                        include($plugin_path.'/'.$field_type.'.php');
                    } ?>
        ...
        <div class="button-groups">
            <a class="button add" href="javascript:void(0);" data-section-wrap="<?php echo esc_attr($data_section_wrap) ?>">Add row</a>
        </div>
    <?php } ?>
    ...
    if (isset($extras) && is_array($extras)) {
        foreach ($extras as $extra) {
            ...
            $multiple              = array_key_exists('multiple', $extra) && isset($extra['multiple']) && $extra['multiple']=='1' ? 'multiple' : '';
            //image element

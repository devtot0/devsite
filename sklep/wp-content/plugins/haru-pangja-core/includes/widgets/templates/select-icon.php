...
<div class="select-wrap element"  data-require-element="<?php if(isset($require_element)){ echo esc_attr($require_element);} ?>"
    ...
    <select class="widefat select2" data-select-icon="1"  id="<?php echo esc_attr($field_output_id); ?>" name="<?php echo esc_attr($field_output_name); ?>" data-allow-clear="<?php echo esc_attr($allow_clear)?>">

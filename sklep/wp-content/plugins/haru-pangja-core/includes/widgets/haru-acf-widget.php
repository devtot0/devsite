 ...
 * @extends     WP_Widget
 */
include_once( PLUGIN_HARU_PANGJA_CORE_DIR . 'includes/widgets/fields/haru-acf.php' );

abstract class Haru_acf_widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        $acf_widget_fields = new Haru_acf_widget_fields($this, $instance);

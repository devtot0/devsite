var haru_media_select = function(text_selector, button_selector, wrapper_selector)  {
    ...
    jQuery(input_text).each(function (i, input) {
        ...
        button.on('click', function (event) {
            ...
            // Make Save button enable @TODO: reselect not change
            button.closest('.widget-inside').find('.widget-control-save').prop('disabled', false);
        });
    });
};